...
public class YouGave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_you_gave);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(YouGave.this,Customer.class);
                startActivity(intent);
                Log.e("tag","MyDatabasehelper");
                MyDatabaseHelper myDB = new MyDatabaseHelper(YouGave.this);
